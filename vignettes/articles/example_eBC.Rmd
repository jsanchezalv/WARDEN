...
evt_react_list <-
  ...
  add_reactevt(name_evt = "progression.mbc",
               input = {
                 ...
                 new_event2(c("2ndline_mbc" = curtime + qexp(rnd_stream_mbc$draw_n(), 0.08)/12))
  ...
  add_reactevt(name_evt = "ttot.early",
               input = {
                 ...
                 if (n_ae>0) {
                     new_event2(c("ae" = curtime + 0.0001))
                     n_ae <- n_ae - 1
                 }
               }) %>%
  ...
  add_reactevt(name_evt = "ae",
               input = {
                 ...
                 modify_event2(c("os" =max(get_event("os") - 0.125,curtime +0.0001) ))#each AE brings forward death by 1.5 months
               }) %>%
