...
As with any model, we need to load inputs, set initial TTE, event reactions, utilities/costs, etc. We'll use the `input_block()` function to have all inputs set-up at once.
