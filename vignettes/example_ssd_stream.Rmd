...
evt_react_list <-
  ...
  add_reactevt(name_evt = "sicker",
               input = {
                 modify_item(list(q_default = util.sick * fl.sick + util.sicker * (1-fl.sick),
                                  c_default = cost.sick * fl.sick + cost.sicker * (1-fl.sick) + if(arm=="int"){cost.int * fl.sick }else{0},
                                  fl.sick = 0)) 
               }) %>%
