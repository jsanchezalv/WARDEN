...
results$output_sim[[1]][[1]][["total_lys_int"]] <- life_years$ly_final[life_years$trt=="int"]
results$output_sim[[1]][[1]][["total_lys_noint"]] <- life_years$ly_final[life_years$trt=="noint"]
