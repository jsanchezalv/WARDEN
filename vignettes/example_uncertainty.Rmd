...
for (sample_size in sample_sizes) {
  ...
  loop_df <- rbind(extract_psa_result(results$output_sim,"costs","noint"),
                   extract_psa_result(results$output_sim,"lys","noint"),
                   extract_psa_result(results$output_sim,"qalys","noint"),
                   extract_psa_result(results$output_sim,"costs","int"),
                   extract_psa_result(results$output_sim,"lys","int"),
                   extract_psa_result(results$output_sim,"qalys","int"))
...
for (sample_size in sample_sizes) {
  ...
  #We're extracting the overall ICER/ICUR and also costs/qalys/lys for the "noint" intervention
  loop_psa_df <- rbind(extract_psa_result(results$output_sim[[1]],"costs","noint"),
                   extract_psa_result(results$output_sim[[1]],"lys","noint"),
                   extract_psa_result(results$output_sim[[1]],"qalys","noint"),
                   extract_psa_result(results$output_sim[[1]],"costs","int"),
                   extract_psa_result(results$output_sim[[1]],"lys","int"),
                   extract_psa_result(results$output_sim[[1]],"qalys","int"))
