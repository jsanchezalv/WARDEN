...
common_all_inputs <-add_item(
                      ...
                      drq = 0.035,
                      random_seed_sicker_i = sample.int(100000,1000,replace = FALSE))  #to be used as seeds to draw the time to event for sicker, to ensure same luck for the same patient independently of the arm
...
list_par <- list(parameter_name = list("util.sick","util.sicker","cost.sick","cost.sicker","cost.int","coef_noint","HR_int"),
                              ...
                              a=list(0.8,0.5,3000,7000,1000,log(0.2),0.8),
                              b=lapply(list(0.8,0.5,3000,7000,1000,log(0.2),0.8), function(x) abs(x/5)),
