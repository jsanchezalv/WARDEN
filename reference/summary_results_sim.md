...
``` r
summary_results_sim(out = results[[1]], arm = NULL, wtp = 50000, sens = 1)
```
...
- out:
  ...
  or a subset of it (e.g., `results[[1]]`). When the full results object
  is passed, `sens` is used to select the appropriate sensitivity
  analysis.
...
- sens:
  ...
  full results object. Defaults to 1.
