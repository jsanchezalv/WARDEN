...
#> Simulation number: 6
#> Time to run simulation 6: 0.42s
...
#> Simulation number: 6
#> Time to run simulation 6: 0.12s
#> Time to run analysis 16: 1.04s
#> Total time to run: 12.79s
#> Simulation finalized;
```
