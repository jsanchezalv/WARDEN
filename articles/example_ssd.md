...
#> Analysis number: 1
#> Simulation number: 1
#> Time to run simulation 1: 0.53s
#> Time to run analysis 1: 0.53s
#> Total time to run: 0.53s
...
#> Simulation number: 6
#> Time to run simulation 6: 0.11s
#> Time to run analysis 16: 0.98s
#> Total time to run: 11.64s
#> Simulation finalized;
```
