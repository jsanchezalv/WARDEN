...
#> Simulation number: 6
#> Time to run simulation 6: 0.14s
#> Time to run analysis 16: 0.89s
#> Total time to run: 13.57s
#> Simulation finalized;
```
...
#> Time to run analysis 1: 1.3s
#> Total time to run: 1.3s
#> Simulation finalized;
```
