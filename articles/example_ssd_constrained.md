...
#> Analysis number: 1
#> Simulation number: 1
#> Time to run simulation 1: 1.11s
#> Time to run analysis 1: 1.12s
#> Total time to run: 1.12s
...
#> Analysis number: 1
#> Simulation number: 1
#> Time to run simulation 1: 1.02s
#> Time to run analysis 1: 1.02s
...
#> Analysis number: 1
#> Simulation number: 1
#> Time to run simulation 1: 1.14s
#> Time to run analysis 1: 1.14s
#> Total time to run: 1.15s
#> Simulation finalized;
...
The model is executed as before, just adding `sensitivity_bool = TRUE`.
The `n_sensitivity` and `sensitivity_names` arguments are auto-detected
from the
[`input_block()`](https://jsanchezalv.github.io/WARDEN/reference/input_block.md)
metadata — no manual configuration required.
...
#> Time to run analysis 7: 0.2s
#> Analysis number: 8
#> Simulation number: 1
#> Time to run simulation 1: 0.16s
#> Time to run analysis 8: 0.16s
#> Analysis number: 9
#> Simulation number: 1
#> Time to run simulation 1: 0.16s
...
#> Simulation number: 1
#> Time to run simulation 1: 0.17s
#> Time to run analysis 13: 0.17s
#> Analysis number: 14
#> Simulation number: 1
#> Time to run simulation 1: 0.16s
#> Time to run analysis 14: 0.17s
#> Total time to run: 2.25s
#> Simulation finalized;
```
...
#> Time to run simulation 5: 0.17s
#> Simulation number: 6
#> Time to run simulation 6: 0.22s
#> Time to run analysis 8: 1.11s
#> Analysis number: 9
#> Simulation number: 1
#> Time to run simulation 1: 0.17s
#> Simulation number: 2
...
#> Time to run simulation 4: 0.19s
#> Simulation number: 5
#> Time to run simulation 5: 0.19s
#> Simulation number: 6
#> Time to run simulation 6: 0.21s
#> Time to run analysis 12: 1.15s
#> Analysis number: 13
#> Simulation number: 1
#> Time to run simulation 1: 0.17s
#> Simulation number: 2
...
#> Simulation number: 6
#> Time to run simulation 6: 0.16s
#> Time to run analysis 14: 1.21s
#> Total time to run: 15s
#> Simulation finalized;
```
...
#>  8           8     0.9         0.580     3156.       7974.    1061.     -1.61 
#>  9           9     0.722       0.7       3156.       7974.    1061.     -1.61 
#> 10          10     0.722       0.580     5000        7974.    1061.     -1.61 
#> 11          11     0.722       0.580     3156.       9000     1061.     -1.61 
#> 12          12     0.722       0.580     3156.       7974.    2000      -1.61 
#> 13          13     0.724       0.579     3145.       7962.    1066.     -0.916
#> 14          14     0.722       0.580     3156.       7973.    1062.     -1.62 
...
The model is executed as before, just activating the `psa_bool` option
and deactivating `sensitivity_bool`.
...
#> Simulation number: 7
#> Time to run simulation 7: 0.17s
#> Simulation number: 8
#> Time to run simulation 8: 0.16s
#> Simulation number: 9
#> Time to run simulation 9: 0.16s
#> Simulation number: 10
#> Time to run simulation 10: 0.17s
#> Time to run analysis 1: 1.62s
#> Total time to run: 1.62s
#> Simulation finalized;
```
...
unique_pt_inputs_multi <- add_item(input={
    if(arm=="int" & i == 1) specialists$add_resource(50) #add 50 specialists if arm == "int"
  }) |> 
  add_item(
    fl.sick = 1,
    q_default = util.sick,
