...
#> Analysis number: 1
#> Simulation number: 1
#> Time to run simulation 1: 0.52s
#> Time to run analysis 1: 0.52s
#> Total time to run: 0.52s
...
common_all_inputs <-
  input_block(base      = df_par[["base_value"]],
              psa       = pick_psa(df_par[["PSA_dist"]], rep(1, length(df_par[["PSA_dist"]])),
                                   df_par[["a"]], df_par[["b"]]),
              sens      = df_par,
