...
#> Analysis number: 1
#> Simulation number: 1
#> Time to run simulation 1: 0.49s
#> Time to run analysis 1: 0.49s
#> Total time to run: 0.5s
...
#> Simulation number: 6
#> Time to run simulation 6: 0.1s
#> Time to run analysis 14: 0.64s
#> Total time to run: 8.71s
#> Simulation finalized;
```
