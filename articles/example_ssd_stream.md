...
#> Simulation number: 6
#> Time to run simulation 6: 0.13s
#> Time to run analysis 14: 0.78s
#> Total time to run: 10.46s
#> Simulation finalized;
```
