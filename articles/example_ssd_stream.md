...
#> Simulation number: 6
#> Time to run simulation 6: 0.14s
#> Time to run analysis 14: 0.82s
#> Total time to run: 11.14s
#> Simulation finalized;
```
