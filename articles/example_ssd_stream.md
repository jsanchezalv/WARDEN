...
#> Simulation number: 6
#> Time to run simulation 6: 0.15s
#> Time to run analysis 14: 0.91s
#> Total time to run: 12.42s
#> Simulation finalized;
```
