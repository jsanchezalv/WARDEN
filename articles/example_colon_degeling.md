...
#> Time to run simulation 1: 9.39s
#> Time to run analysis 1: 9.39s
#> Total time to run: 9.39s
...
#> Simulation number: 1
#> Patient-arm data aggregated across events by selecting the last value for input_out items.
#> Time to run simulation 1: 4.65s
#> Time to run analysis 1: 4.65s
#> Total time to run: 4.65s
#> Simulation finalized;
```
...
#> Time to run simulation 1: 1.13s
#> Simulation number: 2
#> Time to run simulation 2: 0.83s
#> Simulation number: 3
#> Time to run simulation 3: 0.83s
#> Simulation number: 4
#> Time to run simulation 4: 0.83s
#> Simulation number: 5
#> Time to run simulation 5: 1.13s
#> Time to run analysis 1: 5.56s
#> Total time to run: 5.57s
#> Simulation finalized;
