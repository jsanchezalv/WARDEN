...
#> Time to run simulation 1: 9.06s
#> Time to run analysis 1: 9.06s
#> Total time to run: 9.06s
...
#> Simulation number: 1
#> Patient-arm data aggregated across events by selecting the last value for input_out items.
#> Time to run simulation 1: 4.75s
#> Time to run analysis 1: 4.75s
#> Total time to run: 4.76s
#> Simulation finalized;
```
...
#> Time to run simulation 1: 1.23s
#> Simulation number: 2
#> Time to run simulation 2: 0.93s
#> Simulation number: 3
#> Time to run simulation 3: 0.92s
#> Simulation number: 4
#> Time to run simulation 4: 0.86s
#> Simulation number: 5
#> Time to run simulation 5: 0.93s
#> Time to run analysis 1: 5.63s
#> Total time to run: 5.63s
#> Simulation finalized;
