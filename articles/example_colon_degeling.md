...
#> Time to run simulation 1: 12.5s
#> Time to run analysis 1: 12.51s
#> Total time to run: 12.51s
...
#> Simulation number: 1
#> Patient-arm data aggregated across events by selecting the last value for input_out items.
#> Time to run simulation 1: 6.05s
#> Time to run analysis 1: 6.05s
#> Total time to run: 6.05s
#> Simulation finalized;
```
...
#> Simulation number: 4
#> Simulation number: 5
#> Time to run analysis 1: 7.05s
#> Total time to run: 7.05s
#> Simulation finalized;
