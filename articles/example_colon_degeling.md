...
#> Time to run simulation 1: 11.73s
#> Time to run analysis 1: 11.73s
#> Total time to run: 11.73s
...
#> Simulation number: 1
#> Patient-arm data aggregated across events by selecting the last value for input_out items.
#> Time to run simulation 1: 5.71s
#> Time to run analysis 1: 5.72s
#> Total time to run: 5.72s
#> Simulation finalized;
```
...
#> Time to run simulation 1: 1.47s
#> Simulation number: 2
#> Time to run simulation 2: 1.14s
#> Simulation number: 3
#> Time to run simulation 3: 1.09s
#> Simulation number: 4
#> Time to run simulation 4: 1.06s
#> Simulation number: 5
#> Time to run simulation 5: 1.1s
#> Time to run analysis 1: 6.82s
#> Total time to run: 6.82s
#> Simulation finalized;
