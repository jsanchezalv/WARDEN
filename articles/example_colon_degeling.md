...
#> Time to run simulation 1: 12.33s
#> Time to run analysis 1: 12.33s
#> Total time to run: 12.33s
...
#> Simulation number: 1
#> Patient-arm data aggregated across events by selecting the last value for input_out items.
#> Time to run simulation 1: 6.55s
#> Time to run analysis 1: 6.55s
#> Total time to run: 6.55s
#> Simulation finalized;
```
...
#> Time to run simulation 1: 1.56s
#> Simulation number: 2
#> Time to run simulation 2: 1.29s
#> Simulation number: 3
#> Time to run simulation 3: 1.29s
#> Simulation number: 4
#> Time to run simulation 4: 1.23s
#> Simulation number: 5
#> Time to run simulation 5: 1.31s
#> Time to run analysis 1: 7.65s
#> Total time to run: 7.65s
#> Simulation finalized;
