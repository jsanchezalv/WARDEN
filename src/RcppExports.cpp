...
SEXP create_discrete_resource_cpp(int n, bool lifo, int max_queue_capacity, bool allow_multiple_queue);
RcppExport SEXP _WARDEN_create_discrete_resource_cpp(SEXP nSEXP, SEXP lifoSEXP, SEXP max_queue_capacitySEXP, SEXP allow_multiple_queueSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type allow_multiple_queue(allow_multiple_queueSEXP);
    rcpp_result_gen = Rcpp::wrap(create_discrete_resource_cpp(n, lifo, max_queue_capacity, allow_multiple_queue));
    return rcpp_result_gen;
END_RCPP
}
...
void discrete_resource_attempt_free_if_using_cpp(SEXP xptr, int patient_id, bool remove_all, int amount);
RcppExport SEXP _WARDEN_discrete_resource_attempt_free_if_using_cpp(SEXP xptrSEXP, SEXP patient_idSEXP, SEXP remove_allSEXP, SEXP amountSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type xptr(xptrSEXP);
    Rcpp::traits::input_parameter< int >::type patient_id(patient_idSEXP);
    Rcpp::traits::input_parameter< bool >::type remove_all(remove_allSEXP);
    Rcpp::traits::input_parameter< int >::type amount(amountSEXP);
    discrete_resource_attempt_free_if_using_cpp(xptr, patient_id, remove_all, amount);
    return R_NilValue;
END_RCPP
}
...
int discrete_resource_seize_all_cpp(List resource_xptrs, int patient_id, IntegerVector priorities, double start_time, IntegerVector amounts, int policy, bool force_unblock, bool accum_queue);
RcppExport SEXP _WARDEN_discrete_resource_seize_all_cpp(SEXP resource_xptrsSEXP, SEXP patient_idSEXP, SEXP prioritiesSEXP, SEXP start_timeSEXP, SEXP amountsSEXP, SEXP policySEXP, SEXP force_unblockSEXP, SEXP accum_queueSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< bool >::type force_unblock(force_unblockSEXP);
    Rcpp::traits::input_parameter< bool >::type accum_queue(accum_queueSEXP);
    rcpp_result_gen = Rcpp::wrap(discrete_resource_seize_all_cpp(resource_xptrs, patient_id, priorities, start_time, amounts, policy, force_unblock, accum_queue));
    return rcpp_result_gen;
END_RCPP
}
// discrete_resource_release_all_cpp
LogicalVector discrete_resource_release_all_cpp(List resource_xptrs, int patient_id, IntegerVector amounts, bool purge_queues);
RcppExport SEXP _WARDEN_discrete_resource_release_all_cpp(SEXP resource_xptrsSEXP, SEXP patient_idSEXP, SEXP amountsSEXP, SEXP purge_queuesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type resource_xptrs(resource_xptrsSEXP);
    Rcpp::traits::input_parameter< int >::type patient_id(patient_idSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type amounts(amountsSEXP);
    Rcpp::traits::input_parameter< bool >::type purge_queues(purge_queuesSEXP);
    rcpp_result_gen = Rcpp::wrap(discrete_resource_release_all_cpp(resource_xptrs, patient_id, amounts, purge_queues));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_WARDEN_create_discrete_resource_cpp", (DL_FUNC) &_WARDEN_create_discrete_resource_cpp, 4},
    ...
    {"_WARDEN_discrete_resource_attempt_free_if_using_cpp", (DL_FUNC) &_WARDEN_discrete_resource_attempt_free_if_using_cpp, 4},
    ...
    {"_WARDEN_discrete_resource_seize_all_cpp", (DL_FUNC) &_WARDEN_discrete_resource_seize_all_cpp, 8},
    {"_WARDEN_discrete_resource_release_all_cpp", (DL_FUNC) &_WARDEN_discrete_resource_release_all_cpp, 4},
